...
module.exports = function(app) {
    ...
    app.get('/cargarPartido', isPlanillero, function(req, res) {
        ...
        client.get("http://"+cfg.hostname+"/partido/"+req.query.partidoid, function (partido, response) {
            client.get("http://"+cfg.hostname+"/division", function (divisiones, response) {
    ...
    app.post('/cargarPartido', isPlanillero, function(req, res) {
        ...
        client.put("http://"+cfg.hostname+"/partido/"+req.query.partidoid, args, function (data, response) {
