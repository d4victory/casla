...
$("#torneoSelect").change(function(){
    if($("#torneoSelect").val()=="none"){
        ...
        $.get('http://localhost:8080/division/torneo/'+idTorneo, function(divisiones) {
            $.get('http://localhost:8080/cancha/torneo/'+idTorneo, function(canchas) {
...
$("#divisionSelect").change(function(){
    if($("#divisionSelect").val()=="none"){
        ...
        $.get('http://localhost:8080/division/'+idDivision+'/equipos', function(equipos) {
            if ( equipos.length == 0 ){
                $("#elegirEquipo1").hide();
                $("#elegirEquipo2").hide();
                $("#submitForm").prop('disabled', true);
